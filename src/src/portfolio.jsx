                ...
                <Row>
                    ...
                    <Col xs={4} sm={4} md={4}>
                        <SectionHeader>Portfolio</SectionHeader>
                            <PortfolioCard avatarImg={osLogo} img={osPic} data={data["0"]}/><br/><br/>
                            <PortfolioCard avatarImg={espnLogo} img={espnPic} data={data["1"]}/><br/><br/>
                            <PortfolioCard avatarImg={me} img={simonPic} data={data["2"]}/><br/><br/>
                            <PortfolioCard avatarImg={umtLogo} img={dataVizPic} data={data["3"]}/><br/><br/>
                            <PortfolioCard avatarImg={kaiminLogo} img={kaiminPic} data={data["4"]}/>
                    </Col>
                    <Col xs={4} sm={4} md={4}/>
                </Row>
            </WhiteContainer>
